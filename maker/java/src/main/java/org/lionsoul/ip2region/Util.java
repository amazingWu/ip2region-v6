...
public class Util {
     ...
     * @return
     */
    public static long[] ipv62Long(String ipv6) {
        byte[] bytes = IPAddressUtil.textToNumericFormatV6(ipv6);
        ByteBuffer buffer = ByteBuffer.wrap(bytes, 0, 8);
        ByteBuffer buffer1 = ByteBuffer.wrap(bytes, 8, 8);
        return new long[]{buffer.getLong(), buffer1.getLong()};
    }
