...
public class TestUnit {
    ...
    public void test() {
        try {
            DbSearcher _searcher = new DbSearcher(new DbConfig(), "../../data/ip2region.db", QueryType.MEMORY);
            ...
            while ((str = bfr.readLine()) != null) {
                ...
                String fdata = _searcher.search(first_ip);
                ...
                String sdata = _searcher.search(second_ip);
